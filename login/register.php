...
<!DOCTYPE html>
	...
	<body>
        ...
        <article>
            <section>
                <h1>Регистрация</h1>
                <form action="index.php?article=register" id="registerform" method="post"name="registerform">
                    <p>
                    ...
                    <p>Уже зарегистрированы? <a href= "index.php?article=login">Введите имя пользователя</a>!</p>
                </form>
            </section>
        </article>
